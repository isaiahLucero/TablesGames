...
/* package rouletteapp-0.1.0.0 */
#ifndef VERSION_rouletteapp
#define VERSION_rouletteapp "0.1.0.0"
#endif /* VERSION_rouletteapp */
#ifndef MIN_VERSION_rouletteapp
#define MIN_VERSION_rouletteapp(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_rouletteapp */
...
#define CURRENT_COMPONENT_ID "rouletteapp-0.1.0.0-inplace-rouletteapp"
